...
import { TodoItemDto, CreateTodoItemDto, UpdateTodoItemDto, TodoItemStatus, Todo } from '../todo.models';
...
export const updateTodoItem = async (id: number, todoItemDto: UpdateTodoItemDto) => {
    try {
